...
export declare class ProductReturnsService {
    ...
    constructor(productReturnModel: Model<ProductReturnDocument>, productModel: Model<ProductDocument>, srIssueModel: Model<SRIssueDocument>, srPaymentModel: Model<SRPaymentDocument>, companyClaimModel: Model<CompanyClaimDocument>, companyModel: Model<CompanyDocument>, notificationsGateway: NotificationsGateway);
