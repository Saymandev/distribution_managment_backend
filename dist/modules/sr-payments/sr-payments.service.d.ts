...
export declare class SRPaymentsService {
    ...
    constructor(srPaymentModel: Model<SRPaymentDocument>, salesRepModel: Model<SalesRepDocument>, srIssueModel: Model<SRIssueDocument>, productModel: Model<ProductDocument>, companyModel: Model<CompanyDocument>, companyClaimModel: Model<CompanyClaimDocument>, productReturnModel: Model<ProductReturnDocument>);
    ...
    findBySR(srId: string): Promise<any[]>;
